...
- **OpenWisdom** *(not yet public)* - An epistemology engine for LLMs. It stores principles instead of facts, then actively tries to break them, so its knowledge gets sharper over time instead of just larger.
...
<p align="center">
  <img src="ascii-art.svg" alt="ASCII art" width="420" />
</p>
